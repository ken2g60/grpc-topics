...
const file_main_proto_rawDesc = "" +
	...
	"\n" +
	"main.proto\x12\n" +
	"calculator\x1a\rgreeter.proto\x1a\x0efarewell.proto\"(\n" +
	"\n" +
	"AddRequest\x12\f\n" +
	...
	"\vBidFarewell\x12A\n" +
	"\n" +
	"BidGoodbye\x12\x18.farewell.GoodbyeRequest\x1a\x19.farewell.GoodbyeResponseB\x15Z\x13/proto/gen;mainpipbb\x06proto3"
...
var file_main_proto_goTypes = []any{
	...
	(*GoodbyeRequest)(nil),  // 3: farewell.GoodbyeRequest
	(*HelloResponse)(nil),   // 4: calculator.HelloResponse
	(*GoodbyeResponse)(nil), // 5: farewell.GoodbyeResponse
}
